  ...
  return (
    <div className="App">
      ...
      <div className="box text">
        <p>In Germany, 10 People died by the hand of the police in 2015, in 2016 there where 11. Compared to the population, this results in a balance of 1.3 police killings per 10.000.000 inhabitants.
          <br />
